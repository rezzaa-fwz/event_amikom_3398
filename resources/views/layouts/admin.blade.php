...
Buat satu berkas View HTML berekstensi khusus Blade di resources/views/admin/events/index.blade.php, dan rakit struktur
tabel Tailwind CSS berikut untuk melakukan perulangan (looping) baris data:
